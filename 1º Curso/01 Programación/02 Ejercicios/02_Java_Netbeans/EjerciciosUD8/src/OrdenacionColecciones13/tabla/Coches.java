package OrdenacionColecciones13.tabla;
 ...
 */
import java.util.*;
import OrdenacionColecciones13.Vehiculo.Coche;
...
public class Coches {
    ...
    public static void main(String[] args) {
        ...
        Collections.sort(arrSubirMarcha);

        System.out.println();
        System.out.println("Velocidads superiores a 60:");
        for (Coche c : arrSubirMarcha) {
            System.out.print(c.getVelocidad() + " ");
        }
        System.out.println();
        System.out.println();

        Collections.sort(arrBajarMarcha);
