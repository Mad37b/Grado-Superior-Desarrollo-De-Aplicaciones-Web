 ...
 <div id='form'>
    <form id='datos' action='form.php' method='post'>
        ...
        <legend>Introducción de datos</legend>
            ...
            <input type='password' name='password1' id='password1' maxlength="50" value="<?php echo $password1 ?>" /><br />
            ...
            <input type='password' name='password2' id='password2' maxlength="50" value="<?php echo $password2 ?>" />
            </div>
            <div class='campo'>
